...
function _lang_system_page(){
	...
	putValue("#ftpTest",_language.html.system.ftp_test);
...
function _language_english(){
	...
	language.sample.check_rule_not_input_1 = 	"The rule '";
	language.sample.check_rule_not_input_2 = 	"' not select input item.";
	...
	language.html.universal.ftpTest = 			"FTP test";
	...
	language.html.system.ftp_test = 			"FTP TEST";
...
function _language_chinese(){
	...
	language.sample.Sample_rate_alert = 		"取样率为8000Hz时，禁止使用偶数通道。";
	...
	language.sample.check_rule_not_input_1 = 	"切割规则'";
	language.sample.check_rule_not_input_2 = 	"' 无选择输出输入信号。";
	...
	language.html.universal.ftpTest = 			"FTP测试";
	...
	language.html.system.ftp_test = 			"FTP TEST(C)";
...
function _language_t_chinese(){
	...
	language.sample.Sample_rate_alert = 		"取樣率為8000Hz時，禁止使用偶數通道。";
	...
	language.sample.check_rule_not_input_1 = 	"切割規則'";
	language.sample.check_rule_not_input_2 = 	"' 無選擇輸出輸入信號。";
	...
	language.html.universal.submit = 			"提交";
	language.html.universal.ftpTest = 			"FTP測試";
	...
	language.html.system.ftp_test = 			"FTP TEST(TC)";
